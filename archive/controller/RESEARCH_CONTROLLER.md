...
> [docs/foundations/OBSERVER_FOUNDATIONS.md](../../docs/foundations/OBSERVER_FOUNDATIONS.md). Controller work
> remains paused.
...
>
> **For current active work, see [docs/research/RESEARCH.md](../../docs/research/RESEARCH.md) — the Mapping Program.** That document sets the research agenda going forward.
>
> This doc remains the authoritative record of findings F1–F29. When the active doc references an established fact (e.g., "per F25 Part A…"), the evidence lives here. Do not edit this file unless you're correcting a factual error in one of the findings — new work belongs in RESEARCH.md.
>
> **Controller can return:** the controller thesis is paused, not dead. RESEARCH.md §4 defines the criteria under which mapping work would justify resuming controller research.

Last updated: **2026-04-19** · Final agent: Claude Opus 4.7 (1M context)
